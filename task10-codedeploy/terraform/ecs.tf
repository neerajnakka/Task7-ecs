...
resource "aws_ecs_cluster" "main" {
  name = "strapi-ecs-cluster-neeraj"
...
resource "aws_iam_role" "ecs_execution_role" {
  name = "strapi-ecs-execution-role-neeraj"
...
resource "aws_iam_role" "ecs_task_role" {
  name = "strapi-ecs-task-role-neeraj"
...
resource "aws_ecs_service" "strapi" {
  name            = "strapi-service-neeraj"
  cluster         = aws_ecs_cluster.main.id
  task_definition = aws_ecs_task_definition.strapi.arn
  desired_count   = 1
  launch_type     = "FARGATE"
  
  # Capacity Provider Strategy removed in favor of FARGATE launch type per request
  ...
  load_balancer {
    ...
    container_name   = "strapi-app-neeraj"
    container_port   = 1337
  }
