...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "strapi-public-subnet-${count.index + 1}-neeraj"
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "strapi-private-subnet-${count.index + 1}-neeraj"
  }
}
